...
return [
    'modules' => [
        ...
        'MSP_TwoFactorAuth' => 1,
        'Temando_Shipping' => 1,
        'Unit1_CustomConfig' => 0,
        'Unit1_LogPathInfo' => 0,
        'Unit1_Plugins' => 0,
        'Unit1_Test' => 0,
        'Unit1_Test2' => 0,
        'Unit2_CatalogProductPlugin' => 0,
        'Unit2_CatalogProductPreference' => 0,
        'Unit2_CustomNotFound' => 0,
        'Unit2_FlushOutput' => 0,
        'Unit2_HelloWorldController' => 0,
        'Unit2_HelloWorldRedirect' => 0,
        'Unit2_RouterDash' => 0,
        'Unit2_RoutersLog' => 0,
        'Unit2_Secret' => 0,
        'Unit3_HelloWorldBlock' => 0,
        'Unit3_Layout' => 0,
        'Unit3_ProductViewDescriptionBlock' => 0,
        'Unit3_ProductViewDescriptionPlugin' => 0,
